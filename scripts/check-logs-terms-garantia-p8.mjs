...
check('FinanceiroWrite normal não usa warn', !has(finance, "logger.warn('[P0-10][FinanceiroWrite]") && (has(finance, "logger.info('[P0-10][FinanceiroWrite] venda") || has(finance, "logger.diagnostic('[P0-10][FinanceiroWrite] venda")), 'FinanceiroWrite de fluxo normal deve ser info ou diagnostic, nunca warn');
